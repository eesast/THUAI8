...
class MessageOfConstruction final :
 ...
 public:
  ...
  enum : int {
    ...
    kConstructionStateFieldNumber = 2,
    kXFieldNumber = 3,
    kYFieldNumber = 4,
  ...
  void clear_construction_state();
  ::protobuf::ConstructionState construction_state() const;
  void set_construction_state(::protobuf::ConstructionState value);
  private:
  ::protobuf::ConstructionState _internal_construction_state() const;
  void _internal_set_construction_state(::protobuf::ConstructionState value);
  public:
...
// .protobuf.ConstructionState construction_state = 2;
inline void MessageOfConstruction::clear_construction_state() {
  _impl_.construction_state_ = 0;
}
inline ::protobuf::ConstructionState MessageOfConstruction::_internal_construction_state() const {
  return static_cast< ::protobuf::ConstructionState >(_impl_.construction_state_);
}
inline ::protobuf::ConstructionState MessageOfConstruction::construction_state() const {
  // @@protoc_insertion_point(field_get:protobuf.MessageOfConstruction.construction_state)
  return _internal_construction_state();
}
inline void MessageOfConstruction::_internal_set_construction_state(::protobuf::ConstructionState value) {
  
  _impl_.construction_state_ = value;
}
inline void MessageOfConstruction::set_construction_state(::protobuf::ConstructionState value) {
  _internal_set_construction_state(value);
  // @@protoc_insertion_point(field_set:protobuf.MessageOfConstruction.construction_state)
}
