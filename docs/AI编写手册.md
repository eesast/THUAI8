...
![图片](THUAI8\resource\Server.png)
### Client配置
- 切换Mode为Client，此时可以配置Client启动
![图片](THUAI8\resource\Clientdebug.png)
...
![image](THUAI8\resource\Avalonia.png)
