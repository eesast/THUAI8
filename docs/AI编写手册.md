...
![图片](..\resource\Cppbuild.png)
- 生成成功后，**输出**窗口会提示编译成功的信息
![图片](..\resource\Success.png)
...
![图片](..\resource\Server.png)
### Client配置
- 切换Mode为Client，此时可以配置Client启动
![图片](..\resource\Clientdebug.png)
