...
![图片](https://hackmd.io/_uploads/Bk7VIHjkll.png)

3.Python环境配置：确保Python安装版本在3.9以上，否则可能导致grpc版本更新失败
查看方法：在cmd中输入```python --version```查看版本
![图片](https://hackmd.io/_uploads/Hy3gPHikxg.png)

## 选手包下载

1.在开始编写你的AI代码之前，请前往赛事云盘下载选手包下载器兼启动器(Installer)并解压

![屏幕截图 2025-04-27 132736](https://hackmd.io/_uploads/HywGNSiklx.png)


2.运行installer.exe(可能有警告，请点击"更多信息"-"仍然运行")

![屏幕截图 2025-04-27 133856](https://hackmd.io/_uploads/ByhQ4rjJgx.png)
...
- 打开下载器后，选择**调试**界面
![图片](https://hackmd.io/_uploads/B1tnqBsyle.png)
...
![图片](https://hackmd.io/_uploads/SJtznBjkgg.png)
### Client配置
- 切换Mode为Client，此时可以配置Client启动
![图片](https://hackmd.io/_uploads/H1Y_3rsJgx.png)
