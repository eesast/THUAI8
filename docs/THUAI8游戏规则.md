...
- 每局比赛满足下列条件之一即视为结束：
  - 【取经团队】阵营【唐僧】被击杀或【妖怪】阵营【九头元圣】被击杀；
  - 比赛时间达到10分钟。

- 选手需要为己方阵营的6名角色分别编写代码，其中`PlayerID`为0的角色为【唐僧】或【九头元圣】。
...
- 【取经团队】阵营初始时即拥有角色【唐僧】，【妖怪】阵营初始时即拥有角色【九头元圣】。
...
| :----: | :--: | :----------------------------------------------------------: | :--------------------: |
|  唐僧  |  /   |                                                              |           /            |
| 孙悟空 | 近战 |          **火眼金睛**：发出激光束，造成50点贯穿伤害          | 火眼金睛可被障碍物阻挡 |
| 猪八戒 | 近战 | **食神饱餐**：恢复生命值，短时间（15s）增加防御，获得伤害减免 |           /            |
| 沙悟净 | 远程 |  **沙海迷踪**：致盲敌人，使其短时间无法进行有效攻击，持续5s  |     障碍物无法阻挡     |
| 白龙马 | 远程 |     **龙腾四海**：化身为龙，对大范围敌人造成20点冲击伤害     |     障碍物无法阻挡     |
...
取经团队阵营具有特殊单位——猴子猴孙。修建建筑时，必须由该单位进行修建。
...
| :------: | :--: | :----------------------------------------------------------: | :------------: |
| 九头元圣 |  /   |                                                              |       /        |
|  红孩儿  | 近战 | **三昧真火**：对一定范围内的敌人附带每秒15点的灼烧伤害，持续5s |       /        |
|  牛魔王  | 近战 | **坚不可摧**：为自己和范围内血量最低的队友附加一个能抵挡100点伤害的护盾 |       /        |
| 铁扇公主 | 远程 | **芭蕉扇**：击退一定范围内的敌人，并对中了“三昧真火”的敌人附加20点的点燃伤害 | 障碍物可以阻挡 |
|  蜘蛛精  | 远程 |    **蛛网束缚**：定身范围内的敌人，持续5s，并造成10点伤害    | 障碍物无法阻挡 |
...
妖怪阵营具有特殊单位——无名小妖。修建建筑时，必须由该单位进行修建。

|   角色   | 血量 | 攻击力 | 攻击范围 | 经济消耗 | 击杀得分 |
| :------: | :--: | :----: | :------: | :------: | :------: |
| 无名小妖 |  50  |   5    |    1     |   1000   |   500    |

以上的**攻击范围**是一个相对系数，体现角色间攻击范围大小的相对值。具体数值待定。
...
| :--: | :----------------------------------------------------------: | :-----------: | :--: | :------: |
| 兵营 |     角色出生点，开局自带一座兵营，至多可再修建两座兵营。     |    1w/6000    | 600  |   15s    |
| 泉水 |         半径1000范围内的己方角色可持续回血（10点/s）         |   8000/3000   | 300  |   10s    |
| 农场 | 每座农场每秒产出100经济，至多可再修建4个农场，开局自带一个农场 |   8000/4000   | 400  |   10s    |
| 陷阱 | 修建后敌方不可见。当敌方角色触碰以陷阱为中心的九宫格时，受到每秒20点的伤害，持续5s，同时会暴露视野 |     1000      |  /   |    5s    |
| 牢笼 | 修建后敌方不可见。当敌方角色触碰以陷阱为中心的九宫格时，会被定身30s，无法移动，且暴露视野 |     1000      |  /   |    5s    |
...
| 净化药水 |        玩家控制何时使用，角色免疫控制效果，持续30s。         |      2000      |
| 隐身药水 | 7min前可购买，玩家控制何时使用，角色隐身，持续10s。若发起攻击，则立刻破隐。 |      4000      |
| 狂暴药水 | 7min后可购买，玩家控制何时使用，角色攻击力×1.2倍，攻击频率×1.25倍，移速增加300，持续30s。 |       1w       |
